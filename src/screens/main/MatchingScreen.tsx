...
const screens = ['MatchingScreen', 'ProjectsScreen', 'MessagesScreen', 'ProfileScreen'];

export default function MatchingScreen() {
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.content}>
        <Text style={styles.title}>AI-Powered Matching</Text>
        <Text style={styles.subtitle}>Find researchers with complementary skills</Text>
      </View>
    </SafeAreaView>
  );
}
